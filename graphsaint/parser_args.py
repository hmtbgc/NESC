...
def get_args():
    ...
    parser.add_argument("--dataset", type=str, choices=['flickr', 'ogbn-arxiv', 'reddit', 'yelp', 'amazon', 'ogbn-products'],
    ...
    parser.add_argument("--n_layer", type=int, default=4, help="# layer of GNN, including input and output layer")
